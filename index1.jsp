      ...
      <form class="needs-validation" novalidate>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="date" class="form-control" id="orderDate" placeholder="" value="" required>
	...
	<div class="row" id="productdetails">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3"><input class="btn btn-outline-success btn-lg btn-block" id="addProduct" value="Add product" type="submit"></input>
            ...
            <div class="col-md-6 mb-3"><button class="btn btn-outline-danger btn-lg btn-block" id="removeProduct" onClick="removeElement" type="submit">Remove Product</button>
            </div>
        </div>
        <hr class="mb-4">
