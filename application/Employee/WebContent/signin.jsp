...
<title>Insert title here</title>
  ...
  <body class="text-center">
    ...
    <form action="Login" method="post" class="form-signin jumbotron top-top shadow">
  ...
  <label for="inputUsername" class="sr-only">Customer ID</label>
  <input type="text" name="inputUsername" class="form-control shadow-up" placeholder="Enter Customer Username" required autofocus>
  ...
  <div class="">
    <label>
      <p>For <b>Employee</b> Login, <a href="employeelogin.jsp">Click Here</a></p>
    </label>
  </div>
