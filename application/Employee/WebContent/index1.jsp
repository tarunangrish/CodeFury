      ...
      <h4 class="mb-3">Billing address</h4>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input type="text" onchange='saveValue(a);' class="form-control" id="username" name="cid" placeholder="Customer ID" required>
...
<%String val2= request.getParameter("quantity");
  ...
  <br>
	  ...
	  out.println("product Id is "+val);out.println("");
        		   out.println("product Id is "+val1);out.println("");
